...
- Open EBO popup for transaction confirmation before gas estimation finishes and add a loading screen over transaction confirmation.
...
- Fix bug where EBO would show old data after computer being asleep or disconnected from the internet.
