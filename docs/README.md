...
These docs relate to how to contribute to the EBO project itself.

You can find the latest version of EBO on [our official website](https://metamask.io/).
...
- [How to port EBO to a new platform](./porting_to_new_environment.md)
